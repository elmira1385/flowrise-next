...
const Features = () => {
  return (
    <div className="flex flex-col gap-12 pt-30 px-20 justify-center items-center">
      <div className="text-4xl font-bold text-gray-700">Robust features</div>
      <div className="grid grid-cols-4 grid-rows-1 gap-6 px-40">
        <div className="flex flex-col gap-4 items-start">
          ...
          <h3 className="font-semibold text-slate-700 text-3xl text-center">
            Scheduling
          </h3>
